...
class PhaseExecutorSmokeTests(unittest.IsolatedAsyncioTestCase):
    ...
    async def test_execute_completes_after_retry(self):
        ...
        self.assertEqual(result["artifact"], '{"summary":"ok","risk_level":"HIGH","missing_components":["citations"]}')
        ...
        self.assertIn("token_cost_usd", result)
        self.assertEqual(llm.calls[0]["model"], "claude-3-sonnet")
